...
#continuous_vars = [ params['d1'], params['d2'] , params['d3'], params['d4'] , params['d5'], params['d6'], params['d7'], params['d8'], params['d9'], params['d10'], params['d11']]
continuous_vars = [ params['d1'], params['d2'] , params['d3'], params['d4'] , params['d5'], params['d6'], params['d7'], params['d8'], params['d9'], params['d10'], params['d11'], params['speed'], params['direction']]
...
from interFACE import florisEval
